...
import { Heart, Play, Pause, Download, Check, Loader2 } from "lucide-react"
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              {showOffline && (
                <Button
                  ...
                  className={cn("h-8 w-8", isOffline && "text-blue-600")}
                  aria-label={
              ...
              <Button
                ...
                className={cn("h-8 w-8", liked && "text-red-500 hover:text-red-600")}
